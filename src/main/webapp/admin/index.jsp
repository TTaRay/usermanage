...
<div class="main-container" id="main-container">
    ...
    <jsp:include page="public/left.jsp" flush="true">
        <jsp:param name="now" value="index"/>
    </jsp:include>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Bob Doe's avatar"
                                                                     src="/admin/assets/avatars/user.jpg"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Joe Doe's avatar"
                                                                     src="/admin/assets/avatars/avatar2.png"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Jim Doe's avatar"
                                                                     src="/admin/assets/avatars/avatar.png"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Alex Doe's avatar"
                                                                     src="/admin/assets/avatars/avatar5.png"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Susan's avatar"
                                                                     src="/admin/assets/avatars/avatar3.png"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Phil Doe's avatar"
                                                                     src="/admin/assets/avatars/avatar4.png"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Alexa Doe's avatar"
                                                                     src="/admin/assets/avatars/avatar1.png"/>
                                                            </div>
